...
const MusicPlayerV2 = ({
	...
	const {
		...
		audio,
		`${process.env.NEXT_PUBLIC_API_URL}/tracks/${track.identifier}/mp3`
	);
	...
	return (
		...
		>
			<div className={`${styles.cover_container}`}>
				<Image
					src={track?.cover ? track.cover : "/images/track_general_cover.jpg"}
					alt="Cover"
					width={120}
					height={120}
				/>
				...
				<div className="xxs-f-main-justify ">
					...
					<Menu>
						...
						<MenuList bg="#2a2a2a" borderColor="#4d4d4d">
							<a
								href={`${process.env.NEXT_PUBLIC_API_URL}/tracks/${track.identifier}/download`}
								download
							>
