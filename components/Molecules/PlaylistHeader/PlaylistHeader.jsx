	...
	return (
		<header className={`${styles.header} s-f-row xxs-mt-30`}>
			<div className={`${styles.cover_container} relative-element`}>
				<Image
					src={
						data.playlistDetails.cover === "general_cover.jpg"
							? `${process.env.NEXT_PUBLIC_API_URL}/${data.playlistDetails.cover}`
							: `${process.env.NEXT_PUBLIC_API_URL}/playlistsCovers/${data.playlistDetails.cover}`
					}
					alt="Playlist cover"
					layout="fill"
					priority
